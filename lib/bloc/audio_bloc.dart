    ...
    try {
      final playlists = [
        Playlist(
          ...
          creator: 'A&K',
          coverUrl: 'https://picsum.photos/id/39/200/200',
          songIds: ['1', '2', '3'],
        ),
        Playlist(
          id: '2',
        ...
        Playlist(
          ...
          coverUrl: 'https://picsum.photos/id/119/200/200',
          songIds: ['7', '8', '9'],
        ),
        Playlist(
          id: '4',
          name: 'Vibe with me',
          creator: 'housy',
          coverUrl: 'https://picsum.photos/id/103/200/200',
          songIds: ['10', '11', '12'],
        ),
        Playlist(
          id: '5',
          name: 'Listen&Chill',
          creator: 'Hipster',
          coverUrl: 'https://picsum.photos/id/96/200/200',
          songIds: ['13', '14', '15'],
        ),
      ];
      emit(state.copyWith(
